...
class CheckoutValidationRequest
{
    public function __construct(
        ...
        protected CheckoutValidationRequestMapper $mapper,
        protected Client $guzzleClient,
        protected ErpIntegrationConfig $config,
    ) {
        $this->baseRequest->setModelName('CheckoutValidationRequest');
    }

    public function doRequest(ErpCheckoutCartValidationRequestTransfer $requestTransfer): ErpCheckoutCartValidationResponseTransfer
    {
        $requestUrl = $this->config->getCheckoutValidationUrl();
        ...
        try {
            ...
            return $this->baseRequest->handleFailedConnectionResponse(new ErpCheckoutCartValidationResponseTransfer(), $requestTransfer, $exception, $requestUrl, $requestBody, $requestOptions);
        } catch (GuzzleException $exception) {
            return $this->baseRequest->handleGenericRequestFailureResponse(new ErpCheckoutCartValidationResponseTransfer(), $requestTransfer, $exception, $requestUrl, $requestBody, $requestOptions);
        }
    }
}
