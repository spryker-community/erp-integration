...
class DeliveryTimeRequest
{
    public function __construct(
        ...
        protected DeliveryTimeRequestMapper $mapper,
        protected Client $guzzleClient,
        protected ErpIntegrationConfig $config,
    ) {
        $this->baseRequest->setModelName('DeliveryTimeRequest');
    }

    public function doRequest(ErpDeliveryTimeRequestTransfer $requestTransfer): ErpDeliveryTimeResponseTransfer
    {
        $requestUrl = $this->config->getDeliveryTimeUrl();
        ...
        try {
            ...
            return $this->baseRequest->handleFailedConnectionResponse(new ErpDeliveryTimeResponseTransfer(), $requestTransfer, $exception, $requestUrl, $requestBody, $requestOptions);
        } catch (GuzzleException $exception) {
            return $this->baseRequest->handleGenericRequestFailureResponse(new ErpDeliveryTimeResponseTransfer(), $requestTransfer, $exception, $requestUrl, $requestBody, $requestOptions);
        }
    }
}
