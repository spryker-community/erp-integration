...
class OrderExportRequestMapper
{
    public function mapTransferToRequestString(ErpOrderExportRequestTransfer $requestTransfer): string
    {
        return json_encode($requestTransfer->toArray());
    }

    public function mapResponseToResponseTransfer(ResponseInterface $response): ErpOrderExportResponseTransfer
    {
        $responseTransfer = (new ErpOrderExportResponseTransfer());
